import type { GrowthEngineSnapshot } from "@/lib/types";

export const growthEngineSnapshot: GrowthEngineSnapshot = {
  ...
  aiError: {
    ...
    description:
      "The AI agent could not fully verify recent revenue signals on a small subset of premium salons, so it switched to a multi-signal confidence score and pushed those accounts into human review instead of sending risky outreach.",
    fallbacks: [
  ...
  prospects: [
    {
      ...
      fitScore: 96,
      socialHook:
        "Your Brickell scalp bar visuals already educate clients like a wellness concierge.",
      reasons: [
    ...
    },
    {
      ...
      fitScore: 93,
      socialHook:
        "Your Palm Beach audience already buys prestige rituals; MaRe extends that into measurable scalp wellness.",
      reasons: [
    ...
    },
    {
      ...
      fitScore: 90,
      socialHook:
        "Your scalp-first transformations already prime clients for a diagnostic-led upsell conversation.",
      reasons: [
  ...
  outreachDrafts: [
    {
      ...
      channel: "Email",
      subjectLine:
        "A retail conversion ritual your Brickell clients would actually trust",
      ...
      postcardConcept:
        "Embossed ivory postcard with a single yellow status seal and the line: A system worthy of your service floor.",
      guardrail:
        "Only position MaRe as a selective partnership for salons that are luxury enough.",
    },
    {
      salonName: "Casa de Soleil Salon Spa",
      channel: "Postcard + DM",
      subjectLine:
        "Palm Beach luxury clients are ready for scalp wellness with proof",
      ...
      postcardConcept:
        "Satin cream stock featuring a gold circle, product silhouette, and a short ROI story.",
      guardrail:
        "Keep the message high-end, consultative, and specific to their visual brand.",
    },
  ],
  contentAssets: [
    {
      ...
      openingHook:
        "If your hair routine starts at the strand, you are already starting too late.",
      talkingPoints: [
      ...
      callToAction:
        "Book a MaRe consultation in Miami or apply to become a luxury partner salon.",
      status: "Approved",
    },
    {
      id: "content-002",
      ...
      openingHook:
        "Luxury clients do not want more products; they want a system that feels personal.",
      talkingPoints: [
    ...
    },
    {
      ...
      openingHook:
        "Most dandruff content sounds clinical or cheap. Luxury clients deserve better education.",
      talkingPoints: [
      ...
      callToAction:
        "Follow MaRe for scalp-first education and partner salon stories.",
  ...
  reviewQueue: [
    {
      ...
      status: "Needs review",
      nextAction:
        "Approve or downgrade the 14 uncertain luxury leads before outreach sends.",
    ...
    },
    {
      ...
      fallback:
        "If tone slips into AI language, re-run with stricter salon lingo prompts.",
    },
    {
      id: "review-003",
      owner: "Growth Ops",
      ...
      status: "In progress",
      nextAction:
        "Batch publish the approved Shorts and blog briefs into the publishing queue.",
