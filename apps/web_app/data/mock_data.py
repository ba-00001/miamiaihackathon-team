...
AGENT_STATE = {
    ...
    "nextAction": "Keep the drafts visible, but block automated send until a human verifies the uncertain salons.",
    "yellowDot": True,
    "fallbackMessage": "If live AI services fail, keep cached strategy visible, shift to approved templates, and preserve the yellow dot so the developer knows fallback mode is active.",
}
